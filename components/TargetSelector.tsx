...
const AI_ICONS: Record<TargetAI, React.ReactNode> = {
  chatgpt: (
    /* OpenAI logo */
    <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-9 sm:h-9" fill="currentColor" fillRule="evenodd" aria-hidden="true">
  ...
  claude: (
    ...
    <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-9 sm:h-9" fill="#D97757" aria-hidden="true">
  ...
  gemini: (
    /* Google Gemini logo */
    <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-9 sm:h-9" fill="none" aria-hidden="true">
  ...
  universal: (
    <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-9 sm:h-9" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
